...
export function Learn() {
  ...
  return (
    <div className="relative flex h-full flex-col gap-4">
      <div className="group relative overflow-hidden rounded-3xl bg-[url('https://static.theprint.in/wp-content/uploads/2022/04/Web_Photo_Editor-71-1024x576.jpg?compress=true')] bg-cover bg-no-repeat px-16 py-8 text-white transition duration-500 hover:h-[400px]">
        <div className="group-hover:opacity-50 relative z-50">
        ...
        <FillParent className="z-[9] bg-slate-800/50 transition group-hover:opacity-0" />
      </div>
